...
This config make sures that as soon as a specific user has 3 tasks running, for them
to run a new task there should be at least two available threads but only consume one.
