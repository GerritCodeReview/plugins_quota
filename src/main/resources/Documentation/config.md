...
```
  [global]
    maxConnectionsForEndpoint = 10 ^/changes/.*/revisions/.*/review$
    maxConnectionsForEndpoint = 5 ^/projects/.*/branches$

  [group "batch-users"]
    maxConnectionsForEndpoint = 3 ^/changes/.*/revisions/.*/review$
```
