...
/**
 * Utility class responsible for expanding variables in quota-exceeded message templates.
 *
 * <p>This interpolator replaces simple {@code ${var}} placeholders inside a message template with
 * runtime values derived from quota evaluation. It currently supports exactly three variables:
 *
 * <ul>
 ...
 */
class QuotaMessageInterpolator {
