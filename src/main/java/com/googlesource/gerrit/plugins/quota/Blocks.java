...
public class Blocks extends AllRequestFilter {
  ...
  private void doFilter(HttpServletRequest request, HttpServletResponse response, FilterChain chain)
      throws IOException, ServletException {
    System.out.println(getBlockValue());
      System.out.println(shouldBlock(request));
      if (getBlockValue() && shouldBlock(request)) {
          response.sendError(HttpServletResponse.SC_FORBIDDEN, "You have been blocked!");
          return;
      }
