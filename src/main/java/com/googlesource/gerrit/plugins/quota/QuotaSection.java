...
public interface QuotaSection {
  ...
  String KEY_SIZE_EXCEEDED_KNOWN_REQUESTED_MSG = "sizeLimitExceededKnownRequestedMsg";
  String DEFAULT_SIZE_MSG_KNOWN_REQUESTED_TEMPLATE =
      "Requested space [${requested}] is bigger then available [${available}] for repository"
          + " ${project}";
  String KEY_SIZE_EXCEEDED_UNKNOWN_REQUESTED_MSG = "sizeLimitExceededUnknownRequestedMsg";
  String DEFAULT_SIZE_MSG_UNKNOWN_REQUESTED_TEMPLATE =
  ...
  private String getQuotaSizeExceededMessageTemplate(Optional<Long> requested) {
    String msgTemplate =
        requested.isEmpty()
            ? KEY_SIZE_EXCEEDED_UNKNOWN_REQUESTED_MSG
            : KEY_SIZE_EXCEEDED_KNOWN_REQUESTED_MSG;
    String defaultMsgTemplate =
        requested.isEmpty()
            ? DEFAULT_SIZE_MSG_UNKNOWN_REQUESTED_TEMPLATE
            : DEFAULT_SIZE_MSG_KNOWN_REQUESTED_TEMPLATE;
