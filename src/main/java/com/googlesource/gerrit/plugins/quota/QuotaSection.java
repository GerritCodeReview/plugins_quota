...
public record QuotaSection(Config cfg, String namespace, Namespace resolvedNamespace) {
  ...
  public QuotaSection(Config cfg, String namespace, String resolvedNamespace) {
    this(cfg, namespace, new Namespace(resolvedNamespace));
  }
