...
import static com.googlesource.gerrit.plugins.quota.RestApiRequestRateEnforcer.SC_TOO_MANY_REQUESTS;
...
public class RestApiRequestRateEnforcerTest {
  ...
  private static final String limitExceededMsg =
  ...
  private RestApiRequestRateEnforcer restReqFilter;

  @Before
  public void setUp() throws IOException, ServletException {
    restReqFilter =
        spy(
            new RestApiRequestRateEnforcer(
