...
public class QuotaSizeMessageInterpolatorTest {
  ...
  public void interpolateReplacesAllVariables() {
    ...
    String result = QuotaSizeMessageInterpolator.interpolate(template, PROJECT, 100L, 200L);
  ...
  public void interpolateHandlesRepeatedVariables() {
    ...
    String result = QuotaSizeMessageInterpolator.interpolate(template, PROJECT, 42L, 1337L);
  ...
  public void interpolateLeavesUnknownVariablesUntouched() {
    ...
    String result = QuotaSizeMessageInterpolator.interpolate(template, PROJECT, 10L, 20L);
  ...
  public void interpolateWorksWhenNumbersAreZero() {
    ...
    String result = QuotaSizeMessageInterpolator.interpolate(template, PROJECT, 0L, 0L);
